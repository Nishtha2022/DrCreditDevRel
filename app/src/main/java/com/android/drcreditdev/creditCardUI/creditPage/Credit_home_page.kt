package com.android.drcreditdev.creditCardUI.creditPage
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.getStringExtra("day") != null
            ...
            date.text = sharedpreferences.getString("day", "12")
                .toString() + " " + sharedpreferences.getString("month", "Apr")
                .toString() + "'" + sharedpreferences.getString("year", "22").toString()
        }
