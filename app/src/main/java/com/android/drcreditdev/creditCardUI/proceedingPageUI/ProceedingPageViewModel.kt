...
import com.android.drcreditdev.dataModal.reqCreditScore
import com.android.drcreditdev.dataModal.resCreditScore.ExampleJson2KtKotlin
import com.android.drcreditdev.services.ApiClientCredit
...
class ProceedingPageViewModel : ViewModel() {
    ...
    var intentInt: MutableLiveData<Int> = MutableLiveData(3)
