...
import com.android.drcreditdev.databinding.ActivityUserNumberBinding
import com.android.drcreditdev.login.otpVerificationUI.Otp_verification
...
class UserNumber : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnVerify.setOnClickListener(View.OnClickListener {
            var phoneNo = binding.etGetNumber.text.toString()
            ...
            if (viewModel.isValid(phoneNo)) {
                ...
                val phone = binding.etGetNumber.text.toString()
    ...
    private fun enableBtn(enableBool: Boolean) {
        viewModel.proceed.value = enableBool
    }
